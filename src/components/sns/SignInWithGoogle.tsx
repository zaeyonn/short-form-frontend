...
const SignInWithGoogle = ({signInProcess}: Props) => {
  ...
  // 로그인 처리
  const handleLogin = () => {
    const loginUrl = `https://accounts.google.com/o/oauth2/auth?client_id=${import.meta.env.VITE_GOOGLE_OAUTH_CLIENT_ID}&redirect_uri=${import.meta.env.VITE_GOOGLE_OAUTH_CALLBACK_URI}&response_type=code&scope=https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email`
